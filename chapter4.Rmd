...
```
Next, I will plot distributions of the variables and check the summaries of the variables. In most cases the data is not normally distributed (but heavily skewed).
...
```
Then I calculate the distances between the observations.
