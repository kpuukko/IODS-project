...
#compute odds ratio. #The OR represents the odds that an outcome will occur given a particular exposure, 
...
#The model confirmed all the stated hypothesis: all the predictors are all significant predictors of high alcohol consumption 
